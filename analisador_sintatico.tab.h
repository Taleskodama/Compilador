...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    RPAREN = 285,                  /* RPAREN  */
    COLON = 286,                   /* COLON  */
    GT_RELATIONAL = 287,           /* GT_RELATIONAL  */
    LT_RELATIONAL = 288,           /* LT_RELATIONAL  */
    GE_RELATIONAL = 289,           /* GE_RELATIONAL  */
    LE_RELATIONAL = 290,           /* LE_RELATIONAL  */
    EQ_RELATIONAL = 291,           /* EQ_RELATIONAL  */
    AND_LOGICAL = 292,             /* AND_LOGICAL  */
    OR_LOGICAL = 293,              /* OR_LOGICAL  */
    NOT_LOGICAL = 294,             /* NOT_LOGICAL  */
    ID_TOKEN = 295,                /* ID_TOKEN  */
